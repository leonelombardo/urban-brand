const wearingCtn = document.querySelector("#wearing-cards-ctn")
const searchBar = document.querySelector("#wearing-search-bar");

searchBar.addEventListener("search", (e)=>{
    const value = e.target.value;

    wearingCtn.innerHTML = "";

    fetch("../api/wearing.json")
    .then(r => r.json())
        .then(r => {
